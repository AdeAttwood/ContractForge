...
ContractForge is a .NET tool that generates RPC clients and servers from Thrift
IDL files, enabling type-safe cross-language communication using standard HTTP,
...
Unlike gRPC (HTTP/2 + Protobuf), ContractForge uses standard HTTP/1.1 with JSON,
making it:
...
- **GitHub**:
  [AdeAttwood/ContractForge](https://github.com/AdeAttwood/ContractForge)
- **Issues**:
