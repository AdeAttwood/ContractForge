...
ContractForge uses **generators** to transform Thrift IDL files into working code for
...
ContractForge's generator system is extensible. You can create custom generators for:
