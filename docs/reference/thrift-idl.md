...
ContractForge uses Thrift Interface Definition Language (IDL) to define RPC services,
...
ContractForge's Thrift IDL implementation focuses on single-file service definitions,
...
ContractForge focuses on single-file service definitions for the MVP. The following
