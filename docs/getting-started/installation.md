...
This guide will help you install ContractForge and set up your development environment.
...
Since ContractForge is not yet available on NuGet, you'll need to build and install it
from source:
...
- [Explore the generators](../generators/overview.md) to understand what ContractForge
  can generate
...
- Ask in [GitHub Discussions](https://github.com/AdeAttwood/ContractForge/discussions)
