...
public class ThriftListener : ThriftBaseListener
{
    ...
    public override void ExitNamespace(ContractForge.ThriftParser.ThriftParser.NamespaceContext context)
    {
    ...
    public override void ExitInclude(ContractForge.ThriftParser.ThriftParser.IncludeContext context)
    {
    ...
    public override void ExitStruct(ContractForge.ThriftParser.ThriftParser.StructContext context)
    {
    ...
    public override void ExitExceptionStruct(ContractForge.ThriftParser.ThriftParser.ExceptionStructContext context)
    {
    ...
    public override void ExitService(ContractForge.ThriftParser.ThriftParser.ServiceContext context)
    {
    ...
    public override void ExitUnion(ContractForge.ThriftParser.ThriftParser.UnionContext context)
    {
        var union = new Union
        {
            Document = _document,
    ...
    public override void ExitEnum(ContractForge.ThriftParser.ThriftParser.EnumContext context)
    {
    ...
    public static Field BuildField(Document document, ContractForge.ThriftParser.ThriftParser.FieldContext field)
    {
    ...
    public static BaseType BuildType(Document document, ContractForge.ThriftParser.ThriftParser.TypeContext context)
    {
    ...
    public static string EvaluateExpression(ContractForge.ThriftParser.ThriftParser.ValueContext context)
    {
