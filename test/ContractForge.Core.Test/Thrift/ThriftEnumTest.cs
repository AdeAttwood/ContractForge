...
public class ThriftEnumTest
{
    ...
    public void Load_EnumAsStructField_ResolvesCorrectly()
    {
        ...
        Assert.IsType<ContractForge.Core.Types.Enum>(statusField.Type);
        Assert.Equal("Status", ((ContractForge.Core.Types.Enum)statusField.Type).Identifier);
    }
    ...
    public void Load_EnumAsServiceParameter_ResolvesCorrectly()
    {
        ...
        Assert.IsType<ContractForge.Core.Types.Enum>(param.Type);
        Assert.Equal("Status", ((ContractForge.Core.Types.Enum)param.Type).Identifier);
    }
    ...
    public void Load_EnumAsServiceReturnType_ResolvesCorrectly()
    {
        ...
        Assert.IsType<ContractForge.Core.Types.Enum>(func.Type);
        Assert.Equal("Status", ((ContractForge.Core.Types.Enum)func.Type).Identifier);
    }
